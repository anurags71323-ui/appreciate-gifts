import { c as createLucideIcon, d as useParams, u as useCartStore, j as jsxRuntimeExports, S as Skeleton, a as Button, L as Link, B as Badge, b as useAuth, H as Heart } from "./index-76_1P84y.js";
import { u as ue } from "./index-DhkD8Vjj.js";
import { c as useProduct, d as SAMPLE_PRODUCTS, T as Tag, S as ShoppingCart, a as useProducts, b as useWishlist } from "./use-wishlist-B2hrR0BS.js";
...
function WishlistButton({
  ...
  function handleClick() {
    if (!isAuthenticated) {
      ue.info("Sign in to save to your wishlist", {
        action: {
          label: "Sign In",
          onClick: () => void login()
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Button,
    {
      ...
      onClick: handleClick,
      className: `w-full font-body transition-smooth border-2 ${saved ? "border-accent/60 bg-accent/5 text-accent hover:bg-accent/10" : "border-border hover:border-accent/40 hover:text-accent"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(WishlistButton, { productId: product.id, productName: product.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  variant: "outline",
