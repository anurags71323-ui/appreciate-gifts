import { u as useCartStore, r as reactExports, j as jsxRuntimeExports, a as Button, L as Link } from "./index-76_1P84y.js";
import { m as motion } from "./proxy-918R0B7u.js";
import { C as CircleCheckBig, G as Gift } from "./gift-CiEpGWOn.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-24 flex flex-col items-center text-center gap-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-semibold text-foreground tracking-tight", children: "Payment confirmed!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-base leading-relaxed", children: "Thank you for your order. We're carefully packaging your selections and will send a shipping confirmation shortly. Your gift is in good hands." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
